...
- [ ] Описать модель `evidence_records` со всеми полями (actor_id, source_system, review_status и т.д.).
- [ ] Описать модель `evidence_competencies` и связь с `evidence_records`.
